...
ERROR_CODE_CATALOG: dict[str, tuple[str, str]] = {
    ...
    "0xC1450005": ("CapacityThrottle",
                   "Premium capacity throttled - reduce concurrent refreshes or upgrade SKU"),
    "0x0000DEAD": ("ContainerCrash",
                   "Refresh container exited unexpectedly - disable schedule and republish dataset"),
...
UNDERLYING_PATTERNS: list[tuple[str, str, str]] = [
    (r"column\s+'+'+.*wasn'?t found|column\s+\"\".*wasn'?t found",
     ...
     "Power Query references an empty/missing column name - inspect Table.SelectColumns / RenameColumns / ExpandTableColumn / [\"\"] / Field=\"\""),
    ...
    (r"Container exited unexpectedly",
     "ContainerCrash",
     "Refresh container crashed - disable schedule and republish"),
    ...
    (r"timed out|timeout|timeoutexception",
     "Timeout",
